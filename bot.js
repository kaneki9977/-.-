...
${-say}say/يكرر الكلام الي تكتبو
${-serverimage}image/صورة السيرفر
${-members}members/عرض لك عدد كل حالات الاشخاص وعدد البوتات وعدد الاشخاص
${-id}id/معلومات عنك
${-bans}bans / عدد الاشخاص المبندة 
${-avater}avatar/صورتك او صورة الي تمنشنو
...
**
${-moveall}move @user /  لسحب الشخص الى روومك
${-bc}bc / رسالة جماعية الى كل اعضاء السيرفر
${-bk}bk / رسالة جماعيه مع
${-rolebc}rolebc <everyone or @role> / راسال رساله جماعيه لرتبه محدده
${-role}role @user <rank> / لأعطاء رتبة لعضو معين
${-roleremove}roleremove @user <rank> / لازالة الرتبة من شخص معين
